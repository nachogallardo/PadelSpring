...
<script>
	...
	function aniadirJugador(id){		
		document.getElementById(id).style.display = 'none';

		usuarios.push(id);
		if(usuarios.length == numJugadores){
			document.getElementById("jugadores").style.display = 'none';
			document.getElementById("numJugadores").style.display='none';
			document.getElementById("torneo").style.display='block';
			fi=document.getElementById("fiel");
			contenedor=document.createElement('div');
			fi.insertBefore(contenedor,document.getElementById("uno"))
			for (var i = 0; i < usuarios.length; i++) {
				ele=document.createElement('input');
				ele.type='text';
				ele.name='jugones';
				ele.value=usuarios[i];
		...
		<div class="row">
			...
			<div style="margin-left: 15%;" class="col-md-6">
				...
				<div class="row" style="margin-top: 10px;">
					...
					<select name="numJugadores" id="numJugadores" onchange="mostrarJugadores()">
					
						<option value="0">Elige número de jugadores</option>
				 ...
				 <br>
					<div class="row" >
						<div class="col-md-12">
							<table class="table table-hover table-striped" id="jugadores">
								<tbody>
									<c:forEach items="${listaUsuarios}" var="u">
										<tr id="${u.idUsuario }">
											...
											<td><a data-toggle="modal"
												data-target="#borrarUsuario${u.idUsuario }">
													<button class="btn btn-outline-danger" value="left"
														type="button">
														<i class="fa fa-fw s fa-remove"></i>Añadir al torneo
													</button>
											</a></td>
											...
											<div class="modal fade" id="borrarUsuario${u.idUsuario }"
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">¿Estás seguro de añadir el
															usuario al torneo?</div>
														<div class="modal-footer">
															<button type="button" class="btn btn-secondary"
																data-dismiss="modal">No</button>
															<button type="button" data-dismiss="modal" class="btn btn-primary"
																onclick="aniadirJugador(${u.idUsuario})"/>Sí</button>
														</div>
													</div>
												</div>
											</div>
						...
						<div class="row" id="torneo">
							...
							<div class="card-body p-3">
								...
								<c:url value="/addTorneo" var="addTorneo"></c:url>
								<f:form role="form" method="POST" action="${addTorneo }" commandName="torneo"
									class="form-check">
									<div class="form-group">
										<div class="input-group">
											...
											<f:input type="text" maxlength="15" path="nombre" name="nombre" required="required"
									...
									<button type="submit" id="btnRegistrar"
										...
										<i class="fa fa-plus-circle" aria-hidden="true"></i> Crear Torneo
									</button>
									<fieldset id="fiel">
									<input type="text"  hidden="true" id="uno" value="algo" >
									</fieldset>
