...
public class PartidoStringGanador {
	private String jug1;
	private String jug2;
	private String jug3;
	private String jug4;
    ...
    private String idGanador1;
    private String idGanador2;
    
    
    
    
	public PartidoStringGanador(String jug1, String jug2, String jug3, String jug4, int anio, int mes, int dia, int hora,
	...
	public PartidoStringGanador(String jug1, String jug2, String jug3, String jug4, int anio, int mes, int dia,
			int hora, int minutos, String pista, int numJornada, String idGanador1, String idGanador2) {
		super();
		this.jug1 = jug1;
		this.jug2 = jug2;
		this.jug3 = jug3;
